...
import type { BillingMethod, CafeOrder, CafeTable, Category, MenuItem, OrderMode, OrderStatus, PaymentStatus } from "@/types/cafe";
...
const orderSelect =
  "id, order_id, table_id, customer_name, customer_mobile, status, payment_status, billing_method, order_type, total_amount, created_at";
