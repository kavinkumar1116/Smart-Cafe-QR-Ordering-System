...
export async function GET(request: Request) {
  try {
    ...
    const tables = await fetchTables(tenantId);
...
export async function POST(request: Request) {
  try {
    ...
    const created = await insertTable(table, tenantId);
...
export async function PUT(request: Request) {
  try {
    ...
    const updated = await updateTable(id, table, tenantId);
