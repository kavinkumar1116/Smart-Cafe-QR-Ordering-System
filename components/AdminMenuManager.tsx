      ...
      <div className="grid gap-6 xl:grid-cols-[420px_1fr]">
        <form onSubmit={saveItem} className="glass-panel h-fit rounded-lg p-5">
          <div className="flex items-center justify-between gap-3">
            <div>
              <p className="text-sm font-medium text-saffron">Menu Control</p>
              <h2 className="mt-1 text-2xl font-semibold text-crema">{form.id ? "Edit Item" : "Add Item"}</h2>
            </div>
            {form.id ? (
              <button
                type="button"
          ...
          <div className="mt-5 space-y-3">
            ...
            <textarea
              ...
              rows={4}
              className="w-full resize-none rounded-lg border border-white/10 bg-white/10 px-3 py-3 text-crema outline-none placeholder:text-crema/35 focus:border-saffron"
            />
          ...
          >
            ...
            {saving ? "Saving..." : form.id ? "Save Changes" : "Add Menu Item"}
          </button>
        </form>
